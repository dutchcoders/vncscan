...
// https://github.com/TigerVNC/tigervnc/blob/8b5a7d90172d4699dcaa355a05535e5ef07b3cac/java/com/tigervnc/rfb/Security.java
...
const (
	...
	SecurityTypeSSPI   SecurityType = 7
	SecurityTypeSSPIne SecurityType = 8
	...
	SecurityTypePlain     SecurityType = 256
	SecurityTypeTLSNone   SecurityType = 257
	SecurityTypeTLSVnc    SecurityType = 258
	SecurityTypeTLSPlain  SecurityType = 259
	SecurityTypeX509None  SecurityType = 260
	SecurityTypeX509Vnc   SecurityType = 261
	SecurityTypeX509Plain SecurityType = 262
	SecurityTypeIdent     SecurityType = 265
	SecurityTypeTLSIdent  SecurityType = 266
	SecurityTypeX509Ident SecurityType = 267
)
...
func (c *ClientConn) handshake() error {
	...
	fmt.Println(string(protocolVersion[:]))
	...
	// https://tools.ietf.org/html/rfc6143#page-38
	// https://github.com/novnc/noVNC/blob/master/core/rfb.js
	if maxMajor <= 3 && maxMinor <= 3 {
